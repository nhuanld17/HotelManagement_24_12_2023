...
//	}
	...
	public EmployeeGUI() {
		...
		table_1.setFont(new Font("Segoe UI", Font.PLAIN, 16));
		...
		JLabel label_DoanhThu = new JLabel("");
		...
		long Price = new HistoryBUS().totalPrice();
		label_DoanhThu.setText(String.valueOf(Price)+" VNĐ");
		...
		JLabel label_DoanhThu_1 = new JLabel("");
